...
//  }
  ...
  */
  public void setTravelSpeed(final double travelSpeed)
  {
    ...
    int[] speed= {(int)Math.round(travelSpeed * _leftDegPerDistance), (int)Math.round(travelSpeed * _rightDegPerDistance)};
  }
...
//  // _type = Move.MoveType.TRAVEL;
   ...
   // _distance = Double.POSITIVE_INFINITY;
    int[] speed={Math.round(_robotTravelSpeed * _leftDegPerDistance), Math.round(_robotTravelSpeed * _rightDegPerDistance)};
    try {
...
//		_distance = Double.NEGATIVE_INFINITY;
		_angle = 0;
		 int[] speed= {Math.round(_robotTravelSpeed * _leftDegPerDistance),
